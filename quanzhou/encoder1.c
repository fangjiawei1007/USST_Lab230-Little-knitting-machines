		...
		/******************************分层段上压针电机开始***************************************************/
			...
			if (shangyazhen_back_start == 1 && (shangyazhen_pulse_cmp != NO_MOVE)
			   && (yazhen_datou_debug_kb == 0) && (yazhen_xiaotou_debug_kb == 0) && (yazhen_fenceng_debug_kb == 0)){
				...
				if (shangyazhen_back_zero_counter>=(shangyazhen_back_counter +(int)(YAZHEN_ZERO_ERR*shangpan_jiansubi))){//-4
			...
			if (xiayazhen_back_start == 1 && (xiayazhen_pulse_cmp != NO_MOVE)
			   && (yazhen_datou_debug_kb == 0) && (yazhen_xiaotou_debug_kb == 0) && (yazhen_fenceng_debug_kb == 0)){
				...
				if (xiayazhen_back_zero_counter>=(xiayazhen_back_counter + (int)(YAZHEN_ZERO_ERR*xiapan_jiansubi))){//-4
